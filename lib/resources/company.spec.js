...
test('client.company.updateBrandingLogo', () =>
  runTest({
    connect: {
      api_key: 'abc123',
    },
    subject: client => client.company.updateBrandingLogo({ file: '123' }),
    method: 'PUT',
...
test('client.company.updateAnticipation', () =>
  runTest({
    connect: {
      api_key: 'abc123',
    },
    subject: client => client.company.updateAnticipation({
      enabled: true,
      delay: 15,
    }),
    method: 'PUT',
    url: '/company/anticipation',
    body: {
      api_key: 'abc123',
      enabled: true,
      delay: 15,
...
test('client.company.anticipationOptions', () =>
  runTest({
    connect: {
      api_key: 'abc123',
    },
    subject: client => client.company.anticipationOptions(),
    method: 'GET',
    url: '/company/anticipation/options',
    body: {
      api_key: 'abc123',
    },
  })
...
test('client.company.apiKey', () =>
  runTest({
    connect: {
      api_key: 'abc123',
    },
    subject: client => client.company.apiKey(),
    method: 'GET',
    url: '/company/api_key',
    body: {
      api_key: 'abc123',
