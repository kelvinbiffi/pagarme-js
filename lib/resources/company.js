...
const updateBranding = (opts, body) =>
  ...
  /**
   * `PUT /company/branding/logo`
   * Updates a company branding logo from the given payload.
   *
   * @param {Object} opts An options params which
   *                      is usually already bound
   *                      by `connect` functions.
   ...
   *                    data or to an error.
   **/
const updateBrandingLogo = (opts, body) =>
  request.put(opts, routes.company.brandingLogo, body)
 ...
 **/
const updateAnticipation = (opts, body) =>
  request.put(opts, routes.company.anticipation.base, body)
 ...
 *                    or to an error.
 **/
const anticipationOptions = opts =>
  request.get(opts, routes.company.anticipation.options)
 ...
 *                    data or to an error.
 **/
const apiKey = (opts, params) =>
  request.get(opts, routes.company.apiKey, params)
